...
# The line-by-line PyTorch implementation of Open AI's original TensorFlow GPT-2 124 Million Parameters w/Optimization for Apple Silicon(EagerFP32/TF32/BF16/FusedSDPA/JIT/FusedAdamW/DDP)
...
| [Pretraining Datasets (WebText, GPT-3, RedPajama, SlimPajama, FineWeb)](material/datasets_webtext_gpt2_vs_gpt3_guide.md) | Data Pipeline | WebText (Reddit karma), GPT-3 5-source blend, RedPajama-1T, Cerebras SlimPajama (627B deduplicated), and FineWeb-Edu. |
